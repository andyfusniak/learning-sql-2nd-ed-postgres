...
create type cust_type AS enum ('I', 'B');

create table customer
 (cust_id serial,
  fed_id varchar(12) not null,
  cust_type_cd cust_type not null,
  address varchar(30),
  city varchar(20),
  state varchar(20),
...
create type account_status_type AS enum ('ACTIVE', 'CLOSED', 'FROZEN');
...
values ('Michael', 'Smith', '2001-06-22'::date,
  (select dept_id from department where name = 'Administration'),
  'President',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Susan', 'Barker', '2002-09-12'::date,
  (select dept_id from department where name = 'Administration'),
  'Vice President',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Robert', 'Tyler', '2000-02-09'::date,
  (select dept_id from department where name = 'Administration'),
  'Treasurer',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Susan', 'Hawthorne', '2002-04-24'::date,
  (select dept_id from department where name = 'Operations'),
  'Operations Manager',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('John', 'Gooding', '2003-11-14'::date,
  (select dept_id from department where name = 'Loans'),
  'Loan Manager',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Helen', 'Fleming', '2004-03-17'::date,
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Chris', 'Tucker', '2004-09-15'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Sarah', 'Parker', '2002-12-02'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Jane', 'Grossman', '2002-05-03'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Paula', 'Roberts', '2002-07-27'::date,
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'Woburn Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Thomas', 'Ziegler', '2000-10-23'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Woburn Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Samantha', 'Jameson', '2003-01-08'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Woburn Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('John', 'Blake', '2000-05-11'::date,
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'Quincy Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Cindy', 'Mason', '2002-08-09'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Quincy Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Frank', 'Portman', '2003-04-01'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Quincy Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Theresa', 'Markham', '2001-03-15'::date,
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'So. NH Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Beth', 'Fowler', '2002-06-29'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'So. NH Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Rick', 'Tulman', '2002-12-12'::date,
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'So. NH Branch'));
...
values ('CHK','checking account','ACCOUNT','2000-01-01'::date);
insert into product (product_cd, name, product_type_cd, date_offered)
values ('SAV','savings account','ACCOUNT','2000-01-01'::date);
insert into product (product_cd, name, product_type_cd, date_offered)
values ('MM','money market account','ACCOUNT','2000-01-01'::date);
insert into product (product_cd, name, product_type_cd, date_offered)
values ('CD','certificate of deposit','ACCOUNT','2000-01-01'::date);
insert into product (product_cd, name, product_type_cd, date_offered)
values ('MRT','home mortgage','LOAN','2000-01-01'::date);
insert into product (product_cd, name, product_type_cd, date_offered)
values ('AUT','auto loan','LOAN','2000-01-01'::date);
insert into product (product_cd, name, product_type_cd, date_offered)
values ('BUS','business line of credit','LOAN','2000-01-01'::date);
insert into product (product_cd, name, product_type_cd, date_offered)
values ('SBL','small business loan','LOAN','2000-01-01'::date);
...
select cust_id, 'Chilton Engineering', '12-345-678', '1995-05-01'::date from customer
...
insert into business (cust_id, name, state_id, incorp_date)
select cust_id, 'Northeast Cooling Inc.', '23-456-789', '2001-01-01'::date from customer
...
insert into business (cust_id, name, state_id, incorp_date)
select cust_id, 'Superior Auto Body', '34-567-890', '2002-06-30'::date from customer
...
insert into business (cust_id, name, state_id, incorp_date)
select cust_id, 'AAA Insurance Inc.', '45-678-901', '1999-05-01'::date from customer
